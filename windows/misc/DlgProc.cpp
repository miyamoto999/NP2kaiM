	...
	: m_bOpenFileDialog(bOpenFileDialog)
{
	...
	codecnv_utf8toucs2((UINT16 *)m_szDefExt, _MAX_PATH, lpszDefExt, -1);
	...
	{
		codecnv_utf8toucs2((UINT16*)m_szFileName, _MAX_PATH, lpszFileName, -1);
		lstrcpyn(m_szFileNameUtf8, lpszFileName, _countof(m_szFileNameUtf8));
	}
	// Translate filter into commdlg format (lots of \0)
	if (lpszFilter != NULL) {
		m_strFilter = lpszFilter;
		int wlen = codecnv_utf8toucs2(NULL, 0, lpszFilter, -1);
		m_szFilter = new WCHAR[wlen];
		codecnv_utf8toucs2((UINT16*)m_szFilter, wlen, lpszFilter, -1);

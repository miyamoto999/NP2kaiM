...
static const SDLKCNV sdlcnvMini101[] = {
  ...
  {SDL_SCANCODE_APPLICATION,    0x35},  // XFER
#endif
};
...
static UINT8 getKey(SDL_Scancode key) {
  ...
  if(np2oscfg.KEYBOARD == KEY_KEY101) {
    ...
    sdlcnv = (SDLKCNV*)sdlcnv101;
    imax = SDL_arraysize(sdlcnv101);
    sdlcnv2 = (SDLKCNV*)sdlcnvMini101;
    imax2 = SDL_arraysize(sdlcnvMini101);
  } else if(np2oscfg.KEYBOARD == KEY_KEYMINI106) {
    sdlcnv = (SDLKCNV*)sdlcnv106;
    imax = SDL_arraysize(sdlcnv106);
    sdlcnv2 = (SDLKCNV*)sdlcnvMini106;
    imax2 = SDL_arraysize(sdlcnvMini106);
  } else {
    sdlcnv = (SDLKCNV*)sdlcnv106;
    imax = SDL_arraysize(sdlcnv106);
  }
  ...
  if(sdlcnv2) {
      for(i = 0; i < imax2; i++) {
          if(sdlcnv2[i].sdlkey == key) {
              return sdlcnv2[i].keycode;
          }
      }
  }
